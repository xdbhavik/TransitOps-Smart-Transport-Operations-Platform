    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/vehicles/**").hasAnyRole("ADMIN", "FLEET_MANAGER", "FINANCIAL_ANALYST")
                    .requestMatchers("/drivers/**").hasAnyRole("ADMIN", "FLEET_MANAGER", "DISPATCHER", "SAFETY_OFFICER")
                    .requestMatchers("/api/trips/**").hasAnyRole("ADMIN", "FLEET_MANAGER", "DISPATCHER")
                    ...
                    .requestMatchers("/api/expenses/**").hasAnyRole("ADMIN", "FINANCIAL_ANALYST")
