...
export const mockDb = {
  getVehicles: () => getStorageItem('to_vehicles_v2', SEED_VEHICLES),
  saveVehicles: (data) => setStorageItem('to_vehicles_v2', data),

  getDrivers: () => getStorageItem('to_drivers_v2', SEED_DRIVERS),
  saveDrivers: (data) => setStorageItem('to_drivers_v2', data),

  getTrips: () => getStorageItem('to_trips_v2', SEED_TRIPS),
  saveTrips: (data) => setStorageItem('to_trips_v2', data),

  getMaintenance: () => getStorageItem('to_maintenance_v2', SEED_MAINTENANCE),
  saveMaintenance: (data) => setStorageItem('to_maintenance_v2', data),

  getFuel: () => getStorageItem('to_fuel_v2', SEED_FUEL),
  saveFuel: (data) => setStorageItem('to_fuel_v2', data),

  getExpenses: () => getStorageItem('to_expenses_v2', SEED_EXPENSES),
  saveExpenses: (data) => setStorageItem('to_expenses_v2', data),
}
